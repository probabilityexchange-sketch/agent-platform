...
async function check() {
  const signature =
    '2Djb6oZTGV1rEY1oAscZn8xS6W2aAGS2wXmrukKf6jRB2FDftmZ9f9iZSer5fsrSwRTw7xk8kAdHigiyrQZVKgSM';
  ...
  tx.transaction.message.instructions.forEach((ix, i) => {
    console.log(
      `Instruction ${i}:`,
      JSON.stringify(ix, (key, value) => (typeof value === 'bigint' ? value.toString() : value), 2)
    );
  });
}
