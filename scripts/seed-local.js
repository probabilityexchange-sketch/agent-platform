...
async function main() {
  ...
  await prisma.agentConfig.upsert({
    ...
    create: {
      ...
      cpuLimit: 0,
      systemPrompt:
        'You are an expert research assistant. Use search tools to find the most up-to-date and accurate information. Always cite your sources.',
      tools: researchTools,
  ...
  await prisma.agentConfig.upsert({
    ...
    create: {
      ...
      cpuLimit: 0,
      systemPrompt:
        "You are Randi, the lead agent platform director. Your job is to facilitate user requests. You have access to specialized agents: 'research-assistant', 'code-assistant', and 'productivity-agent'.",
      tools: leadTools,
      defaultModel: 'meta-llama/llama-3.3-70b-instruct:free',
      active: true,
    },
