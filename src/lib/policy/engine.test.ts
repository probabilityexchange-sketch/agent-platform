...
describe('Policy Engine - Tool Call Evaluation', () => {
      ...
      scopes: [
        {
          ...
          mode: 'read',
          resources: ['repo:acme/platform'],
          reason: 'Read repo issues',
        },
      ],
    });
  ...
  it('handles crypto tool actions with allowlisted destination', () => {
    const decision = evaluatePolicy({
      ...
      scopes: [
        { tool: 'WALLET_SEND_TOKEN', mode: 'write', resources: ['wallet'], reason: 'Send token' },
      ],
