...
export const SUPPORTED_COMPOSIO_TOOLKITS: readonly ComposioToolkitDef[] = [
  ...
  },
  {
    ...
    category: "Data & Analytics",
    icon: "🌐",
    description: "Query Google SERPs with structured output — essential for keyword research, competitor analysis, and SEO audits.",
    envKey: "COMPOSIO_AUTH_CONFIG_SERPAPI",
    capabilities: ["Keyword SERP analysis", "Competitor page research", "Google Trends", "News & image search"],
    suggestedPrompt: "Search Google for 'ai seo agency' and tell me who ranks in the top 5 and why.",
  },
  {
    ...
    category: "Data & Analytics",
    icon: "📈",
    description: "Pull site traffic, top pages, and conversion data to measure SEO performance.",
    envKey: "COMPOSIO_AUTH_CONFIG_GOOGLEANALYTICS",
    capabilities: ["Traffic reports", "Top landing pages", "Conversion tracking", "Real-time visitors"],
    suggestedPrompt: "Show me the top 10 landing pages for randi.agency from Google Analytics this month.",
  },
  {
    slug: "openweather",
    label: "OpenWeather",
  ...
  },
  {
    ...
    category: "AI & Automation",
    icon: "🔗",
    description: "Trigger scenarios and automate Make.com workflows — great for recurring SEO reporting and data pipelines.",
    envKey: "COMPOSIO_AUTH_CONFIG_MAKE",
    capabilities: ["Trigger scenarios", "Automate workflows", "SEO reporting pipelines"],
    suggestedPrompt: "Trigger my weekly SEO report scenario in Make.",
  },
