...
const CURATED_TOOLKIT_TOOLS: Record<string, string[]> = {
  ...
  googleanalytics: [
    'GOOGLEANALYTICS_GET_TRAFFIC_DATA',
    'GOOGLEANALYTICS_LIST_ACCOUNTS',
    'GOOGLEANALYTICS_LIST_PROPERTIES',
    'GOOGLEANALYTICS_GET_REAL_TIME_DATA',
    'GOOGLEANALYTICS_GET_PAGE_VIEWS',
  ],
  googledocs: [
    'GOOGLEDOCS_CREATE_DOCUMENT',
    'GOOGLEDOCS_GET_DOCUMENT',
    'GOOGLEDOCS_UPDATE_DOCUMENT',
    'GOOGLEDOCS_APPEND_TEXT_TO_EXISTING_DOCUMENT',
  ...
  googledrive: [
    ...
    'GOOGLEDRIVE_UPLOAD_FILE_FROM_URL',
