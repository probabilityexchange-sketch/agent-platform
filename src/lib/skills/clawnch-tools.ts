...
export const CLAWNCH_TOOLS: ChatTool[] = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Upload a token logo image to Clawnch. Accepts a base64-encoded image or a public URL.',
      parameters: {
        type: 'object',
        properties: {
          image: {
      ...
      parameters: {
        ...
        properties: {
          ...
          type: {
            type: 'string',
            enum: ['offer', 'request'],
            description: 'Whether you are offering or requesting',
          },
          category: {
            type: 'string',
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Get this agent's status, ClawRank score, and active intents on the Molten network.",
      parameters: {
        type: 'object',
        properties: {
          apiKey: { type: 'string', description: 'Molten API key' },
