...
const featuredSkills = [
  {
    ...
    description:
      'Automated trading across 100+ exchanges. Market making, arbitrage, and portfolio management.',
    icon: '🤖',
  },
  {
    slug: 'polymarket',
    name: 'Polymarket',
    description:
      'Real-time prediction market analysis and execution. Bet on world events via the CLI.',
    icon: '🗳️',
  },
  {
    slug: 'clawnch',
    name: 'Clawnch',
    description:
      'The autonomous launchpad. Deploy tokens, manage liquidity, and coordinate launches.',
    icon: '🚀',
  },
  {
    slug: 'react-expert',
    name: 'React & UX',
    description:
      'Deep domain knowledge in modern web builds, design systems, and component architecture.',
    icon: '🎨',
  },
];
    ...
    <div className="space-y-12">
      <section>
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm font-medium">
              How Randi routes value across internal credits, machine payments, and traditional
              rails.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="glass-card p-6 rounded-3xl border border-border/50 hover:border-primary/30 transition-all group">
            <div className="text-[10px] font-black tracking-widest text-primary mb-2 uppercase italic">
              Tier 1: Native
            </div>
            <h3 className="text-lg font-bold mb-3">$RANDI Credits</h3>
            <p className="text-xs text-muted-foreground leading-relaxed mb-6">
              The internal engine of the ecosystem. Used for LLM reasoning, container orchestration,
              and basic tasks.
            </p>
          ...
          {/* Machine Tier */}
          <div className="glass-card p-6 rounded-3xl border border-border/50 hover:border-primary/30 transition-all group">
            <div className="text-[10px] font-black tracking-widest text-success mb-2 uppercase italic">
              Tier 2: M2M
            </div>
            <h3 className="text-lg font-bold mb-3">x402 Protocol</h3>
            <p className="text-xs text-muted-foreground leading-relaxed mb-6">
              Direct machine-to-machine payments. Allows Randi to pay for infrastructure (like
              Alchemy) instantly using crypto.
            </p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-white">
          ...
          <div className="glass-card p-6 rounded-3xl border border-border/50 hover:border-primary/30 transition-all group highlight-border">
            <div className="text-[10px] font-black tracking-widest text-accent mb-2 uppercase italic">
              Tier 3: Fiat Web
            </div>
            <h3 className="text-lg font-bold mb-3">AgentCard</h3>
            <p className="text-xs text-muted-foreground leading-relaxed mb-6">
              Autonomous spending at traditional stores. Randi generates virtual Visas to pay for
              domain names, SaaS, and more.
            </p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-white">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Knowledge skills such as <b>React Expert</b> and <b>UX Design</b> shape planning
                    quality. Randi reads these docs before execution.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Action skills such as <b>Clawnch</b> provide tool access. Randi can run scripts,
                    deploy contracts, and execute workflows from chat.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm mb-1 uppercase tracking-wider text-primary">
                    Trading Core
                  </h4>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    With <b>Hummingbot</b> and <b>Polymarket</b>, Randi can reason about
                    cross-exchange opportunities, prediction markets, and liquidity operations.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/skills"
            className="inline-flex items-center gap-1 rounded-full border border-primary/30 bg-primary/5 px-4 py-1.5 text-[10px] font-black text-primary tracking-widest uppercase transition-colors hover:bg-primary/10"
          >
            Browse All
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {featuredSkills.map(skill => (
            <Link
              ...
              className="glass-card p-6 rounded-3xl border border-white/5 hover:border-primary/20 transition-all group"
            >
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 glass-card p-8 rounded-3xl border border-white/5">
          <h3 className="text-sm font-black italic mb-4 uppercase tracking-widest">
            Self-Sustaining Logic
          </h3>
          <p className="text-xs text-muted-foreground leading-relaxed">
            Holders of the <b>$RANDI</b> token drive the deflationary feedback loop. Every credit
            spent on the platform contributes to the verified burn schedule, ensuring the more Randi
            works, the rarer the token becomes.
          </p>
        </div>
        <div className="flex-1 glass-card p-8 rounded-3xl border border-white/5 text-center flex flex-col items-center justify-center">
          ...
          <div className="flex gap-4">
            <Link
              href="/chat"
              className="px-6 py-2.5 bg-primary text-white text-xs font-black rounded-xl hover:translate-x-1 transition-transform"
            >
              ASK RANDI
            </Link>
            <Link
              href="/credits"
              className="px-6 py-2.5 bg-white text-black text-xs font-black rounded-xl hover:-translate-y-1 transition-transform"
            >
              TOP UP
            </Link>
          </div>
