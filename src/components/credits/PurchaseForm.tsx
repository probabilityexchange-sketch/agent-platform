                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      ~{pkg.estimatedStandardCalls} Standard / ~{pkg.estimatedPremiumCalls} Premium
                      calls
                    </p>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-primary">
                      {pkg.creditAmount.toLocaleString()} Credits
                    </div>
                    <div className="text-[10px] text-muted-foreground">${pkg.usdPrice} USD</div>
                  </div>
                </div>
              </button>
            ))}
            ...
            <div className="flex items-center gap-2 mb-2 text-orange-400">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  ...
                  strokeWidth={2}
                  d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.5-7 3 3 3.5 1.354 3.5 5.5s-.354 3.5-5.5 3.5c0 2 2.5 2 2.5 2z"
                />
              </svg>
              <span className="text-xs font-bold uppercase tracking-wider">Burn Flywheel</span>
            </div>
            <p className="text-[11px] text-muted-foreground mb-2">
              Every credit purchase triggers a deflationary burn. 70% of your payment is permanently
              removed from supply.
            </p>
