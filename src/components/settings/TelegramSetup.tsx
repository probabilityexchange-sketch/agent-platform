      ...
      <div className="bg-primary/5 p-6 border-b border-border flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground font-medium">
            Control Randi directly from your phone
          </p>
        </div>
      </div>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                . Type{' '}
                <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-bold text-foreground">
                  /newbot
                </code>{' '}
                and follow instructions to give it a name and username.
              </p>
            </div>
            <button
              onClick={() => setStep(2)}
        ...
        {step === 2 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                BotFather will send you a message with an <strong>API Token</strong> (it looks like{' '}
                <code className="bg-muted px-1.5 py-0.5 rounded text-xs opacity-60">
                  123456:ABC-DEF...
                </code>
        ...
        {step === 3 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="space-y-4">
              ...
              />
              {error && (
                <p className="text-destructive text-sm font-bold bg-destructive/10 p-3 rounded-lg border border-destructive/20">
                  {error}
                </p>
              )}
          ...
          <div className="space-y-8 text-center py-4 animate-in zoom-in-95 duration-500">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Your Telegram bot is now connected. Send it a message to start controlling Randi
                from anywhere.
              </p>
            </div>
            <button
