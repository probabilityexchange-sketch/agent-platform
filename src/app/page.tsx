    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-background/50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
          Instant access to specialized AI agents with 1000+ tool integrations. Sign in once, chat
          everywhere. Free tier available for everyone.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-left">
            ...
            <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-3.04l.533-.811a7.122 7.122 0 00-.657-1.496 6.505 6.505 0 01-1.45-6.355 6.505 6.505 0 019.592-2.983 6.505 6.505 0 001.384 1.06 6.505 6.505 0 014.285 5.91 6.505 6.505 0 00.413 2.053m-6.222 2.518V21m0 0h2.497m-2.497 0H12m0 0V21m0-10V5m0 0L9 8m3-3l3 3"
                />
              </svg>
            </div>
            <h3 className="font-semibold mb-2">Social & Wallet Auth</h3>
            <p className="text-sm text-muted-foreground">
              Sign in with Google, Twitter, or your favorite wallet via Privy. Seamless onboarding
          ...
          <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-colors">
            ...
            <p className="text-sm text-muted-foreground">
              Chat directly with agents specialized in research, coding, and productivity. Powered
              by Kilo Code for the best AI models.
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-colors">
            ...
            <p className="text-sm text-muted-foreground">
              Composio integration allows your agents to interact with GitHub, Slack, Gmail, and
              1000+ other apps.
            </p>
          </div>
        </div>
