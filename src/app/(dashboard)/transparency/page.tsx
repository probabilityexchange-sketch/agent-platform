    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Real-time monitoring of RANDI token burns and treasury flows.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-card border border-orange-500/20 rounded-xl p-6 relative overflow-hidden group">
          ...
          <p className="text-xs uppercase tracking-widest text-muted-foreground mb-1">
            {loading || data?.totalBurnedSource === 'on_chain'
              ? 'On-Chain Burned 🔥'
              : 'Accounted Burn Estimate'}
          </p>
        ...
        <div className="bg-card border border-border rounded-xl p-6 relative overflow-hidden group">
          ...
          >
            ...
            <p className="text-xs uppercase tracking-widest text-muted-foreground mb-1 group-hover:text-primary transition-colors">
              RANDI Market Cap 📈
            </p>
      ...
      <div className="mt-8 p-6 bg-muted/20 rounded-xl border border-dashed border-border text-center">
        <p className="text-sm text-muted-foreground">
          Purchase and subscription flows can prove burn on-chain immediately. Usage fees are always
          accounted in the ledger, and move on-chain once the batch burn service runs with a
          configured treasury signer.
        </p>
      </div>
    </div>
  );
