...
export const metadata: Metadata = {
  ...
  description:
    'Connect your Solana wallet, deposit tokens, and spin up hosted AI agent containers instantly. No setup required. Pay with $RANDI.',
  keywords: [
    'AI agents',
    'Solana',
    'blockchain',
  ...
  openGraph: {
    ...
    title: 'Randi - Launch AI Agents Instantly',
    description:
      'Connect your Solana wallet, deposit tokens, and spin up hosted AI agent containers instantly.',
    siteName: 'Randi',
    images: [
      {
        url: '/og-image.png',
